...
| M5 | Local/remote tunnels, dedicated sessions, health/recovery, proxy detection | Complete | `pnpm verify`; 31 unit, 4 real SSH integration, 2 Electron E2E; isolated LocalForward/RemoteForward, bind conflict, forced disconnect recovery, Clash protocol probes, UI profile round-trip; Docker OpenSSH bidirectional traffic/isolation job | `feat(m5): deliver resilient SSH tunnels` |
| M6 | Collector/supervisor, charts, processes/signals, GPU, btop/watchdog | In progress | Pending | Pending |
