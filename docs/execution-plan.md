...
| M9 | Security audit, redaction, Windows E2E, packaging, docs, release candidate | Complete | `pnpm verify`, `pnpm test:e2e`, `pnpm audit`, `pnpm dist:win`; 52 unit, 4 integration, 2 Electron E2E; two-container Docker direct/ProxyJump and complete SSH lifecycle; portable startup and clean NSIS install/launch/uninstall; packaged fuse readback; secret scan; final hashes and release docs | `1308435` |
